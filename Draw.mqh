...
//|                                                                  |
//+------------------------------------------------------------------+
void Box(string nameBox, datetime time_x, double price_x, datetime time_y, double price_y)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
void Line(string nameLine, const datetime time_x, const double price_x=NULL, const datetime time_y=NULL, const double price_y=NULL)
  {
   if(price_x==NULL)
     {
