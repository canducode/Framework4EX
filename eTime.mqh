...
//|                                                                  |
//+------------------------------------------------------------------+
datetime eTime::OpenDaily(datetime date)
  {
...
//|                                                                  |
//+------------------------------------------------------------------+
datetime eTime::CloseDaily(datetime date)
  {
   MqlDateTime time_mql;
   TimeToStruct(date, time_mql);
   time_mql.hour = 23;
   time_mql.min = 59;
   time_mql.sec = 00;
...
//+------------------------------------------------------------------+
datetime eTime::Yesterday(datetime date, const int days_ago=1)
  {
   int oneDay = 60*60*24,
       forDay = 0;
